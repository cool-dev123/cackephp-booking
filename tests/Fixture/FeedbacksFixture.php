...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'commentaire' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'annonce_id' => 1,
            'utilisateur_id' => 1,
            'created' => '2018-04-04 14:47:33',
            'modified' => '2018-04-04 14:47:33'
        ],
    ];
}
