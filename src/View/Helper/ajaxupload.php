 ...
 */ 
     ...
     function _wrapper($id, $script) { 
        ...
        $scr = implode(',', $script); 
        //$script = "document.observe(\"dom:loaded\", function() { ajxupd_$id = new AjaxUpload('$id',{{$scr}});});"; 
        $script = "$('document').ready(function() { ".
                  "     ajxupd_$id = new AjaxUpload('$id',{{$scr}});".
                  "});";
 ...
 */ 
    ...
    function _submit($id, $options) { 
        ...
        if (!empty($options['files'])) { 
            ...
            $submit .= "if (ext && /^($file)$/.test(ext)){ } else { alert('Seul le type $type est accepté'); return false; }; "; 
        } 
        ...
        if (!empty($options['submitAction'])) {
            $submit .= $options['submitAction'];
        }
