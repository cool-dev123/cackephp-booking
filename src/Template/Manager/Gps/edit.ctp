...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h5 class="txt-dark">Modifier une cordonné gps</h5>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php
                  echo $this->Form->create(null,['type' => 'file','url'=>'/manager/parametrage/gps/edit/'.$residance->id,'id'=>'frm_periode','class'=> 'form-horizontal']);
				 ?>
                        <div class="form-group">
                            <label class="control-label mb-10 col-sm-3 col-lg-2 text-left txt-black font-16">Titre : <sup class='text-danger'>*</sup></label>
                            <div class="col-lg-3 col-sm-9">
                                <?php echo $this->Form->input('name',['value'=>$residance->name,'id'=>'name','label'=>false,'class'=>'form-control']);  ?>                       
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label mb-10 col-sm-3 col-lg-2 text-left txt-black font-16">Bibliothèque : <sup class='text-danger'>*</sup></label>
                            <div class="col-lg-3 col-sm-7 col-xs-8 col-md-8">
                                <select name="bibliotheque_id" class="form-control" id="biblio">
                                    <?php foreach($bibliotheques as $bibliotheque):?>
                                        <option data-image="<?php echo $bibliotheque->image ?>"  <?php if($bibliotheque->id==$residance->bibliotheque_id) echo 'selected' ?> value="<?php echo $bibliotheque->id ?>" ><?php echo $bibliotheque->name ?></option> 
                                    <?php endforeach;?>
                                </select>
                            </div>
                        ...
                        <div class="form-group nameurldiv" <?php if($residance->bibliotheque_id != 1) echo 'style="display:none;"'; ?> >
                            ...
                            <div class="col-lg-3 col-sm-9">
                                <?php echo $this->Form->input('name_url',['value'=>$residance->name_url,'id'=>'name_url','label'=>false,'class'=>'form-control']);  ?>                       
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label mb-10 col-sm-2 col-lg-2 text-left txt-black font-16">Position : <sup class='text-danger'>*</sup></label>
                            <div class="row">
                                <div class="col-sm-4 form-group row">
                                    <label class="control-label col-sm-4 col-md-4 text-left txt-black font-16">Latitude</label>
                                    <div class="col-sm-8 col-md-8">
                                        <input id="lat" name="latitude" class="form-control" type="text" placeholder="saisir latitude">
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group row">
                                    <label class="control-label col-sm-4 col-md-4 text-left txt-black font-16">Longitude</label>
                                    <div class="col-sm-8 col-md-8">
                        ...
                        <!--MAP-->
                        <div class="form-group">
                            <label class="control-label mb-10 col-sm-2 text-left txt-black font-16">Village : <sup class='text-danger'>*</sup></label>
                            <div class="col-lg-3 col-sm-10">
                                <select name="id_village" class="form-control" id="id_village">
                                    <?php foreach($villages as $village):?>
					                            <option <?php if($village->id==$residance->id_village) echo 'selected' ?> value="<?php echo $village->id ?>" ><?php echo $village->name ?></option> 
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                        <!-- Image header -->
                        <div class="form-group row mt-20 imageheaderdiv" <?php if($residance->bibliotheque_id != 1) echo 'style="display:none;"'; ?>>
                          ...
                          <div class="form-group row mt-20 imageheaderdiv" <?php if($residance->bibliotheque_id != 1 || $residance->image_header == "") echo 'style="display:none;"'; ?>>
                            <label class="control-label mb-10 col-sm-2 text-left font-16 txt-black">Ancienne Image :</label>
                            <div class="col-lg-6 col-sm-10">
                              <img height="200" width="100%" src="<?= $this->Url->build('/',true)?>images/header_residence/<?= $residance->image_header;?>">
                            </div>
                          </div>
...
$( document ).ready(function() {
    ...
    <?php if(!empty($confirm_res)): ?>
        $.toast().reset('all');
                        ...
                        $.toast({
                            heading: 'Une nouvelle cordonné a été modifié',
                            text: '',
    ...
    center :{
        lat: <?php if(!empty($residance->latitude) ) echo $residance->latitude.''; else echo 46.734255.''; ?>,
        lng: <?php if(!empty($residance->longitude) ) echo $residance->longitude.''; else echo 2.418815.''; ?>
    },
    zoom:15
});
