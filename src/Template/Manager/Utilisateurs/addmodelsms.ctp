...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <h5 class="txt-dark">Nouveau modele sms</h5>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php
                  echo $this->Form->create('Modelmessage',['url'=>'/manager/utilisateurs/addmodelsms','id'=>'frm_periode','class'=> 'form-horizontal']);
                  echo $this->Form->input('id_gestionnaire',['type'=>'hidden','value'=>$InfoGes['G']['id']]);
                  ?>
                <div class="form-group row">
                    <label class="control-label mb-10 col-sm-4 col-lg-3 text-left font-16 txt-black">Titre: <sup class='text-danger'>*</sup></label>
                    <div class="col-lg-4 col-sm-8">
                        <?php echo $this->Form->input('titre',['type'=>'text','id'=>'titre','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label mb-10 col-sm-4 col-lg-3 text-left font-16 txt-black">Sujet: <sup class='text-danger'>*</sup></label>
                    <div class="col-lg-4 col-sm-8">
                        <?php echo $this->Form->input('sujet',['type'=>'text','id'=>'sujet','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
                <div class="form-group">
                    <label id="txtmessage" class="control-label mb-10 col-sm-4 col-lg-3 text-left font-16 txt-black">Message <br>(reste 160 caractère) : <sup class='text-danger'>*</sup></label>
                    <div class="col-lg-4 col-sm-8">
                        <textarea type="" name="txtsms" rows="5" id="message" onkeyup="txtreste()"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-4 col-sm-8">
                        <div class="checkbox">
                            <input id="info" type="checkbox" value="info" name="typesms">
                            <label for="info"> Information </label>
                        </div>
                        <div class="checkbox">
                            <input id="commerce" type="checkbox" value="commerce" name="typesms">
  ...
  if ($box.is(":checked")) {
    ...
    <?php if(!empty($confirm_res)): ?>
        $.toast().reset('all');
                        ...
                        $.toast({
                            heading: 'Un nouveau modele sms a été  ajouté',
                            text: '',
