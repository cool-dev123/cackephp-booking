      ...
      <div class="row-fluid">
        ...
        <div class="widget  span12 clearfix" >
            ...
            <div class="widget-content">
                <?php
                  echo $this->Form->create(null,['url'=>'/manager/utilisateurs/add','id'=>'frm_model_mail']);
				 ...
				 echo $this->Form->input("mdp",["label"=>"Mot de passe ","type"=>"password",'templates' => ['inputContainer' => "<div class='section'> {{content}}</div>"],'class'=>'validate[required]']);
				 echo $this->Form->input("mdp_compare",["label"=>"Saisissez le à nouveau ","type"=>"password",'templates' => ['inputContainer' => "<div class='section'> {{content}}</div>"],'class'=>'validate[required,equals[mdp]]']);
