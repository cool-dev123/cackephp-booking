<div class="row heading-bg icantSelectIt">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h5 class="txt-dark">Modifier modele mail</h5>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php
                  echo $this->Form->create($modelmessage,['url'=>'/manager/utilisateurs/editmodel/'.$modelmessage->id,'id'=>'frm_periode','class'=> 'form-horizontal']);
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-12">
                        <textarea class="form-control textarea_editor" type="" name="txtmail" rows="15" cols="30" id="message"><?php echo $modelmessage->txtmail ?></textarea>
                    </div>
                </div>
