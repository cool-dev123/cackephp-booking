            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="text-center button-list">
                            ...
                            <button class="btn btn-success mt-5">Modèle sms</button>
        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading icantSelectIt">
                <div class="pull-left mt-10">
                        <h6 class="panel-title txt-dark">Modele sms</h6>
                </div>
                <div class="pull-right">
                    <a href="<?php echo $this->Url->build('/',true)?>manager/utilisateurs/addmodelsms/" class="btn  btn-primary pull-right">Ajouter modele</a>
                </div>
                                ...
                                <tbody>
                                    <?php foreach($modelmessage as $key=>$enr):?>
                                        <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <button class="btn btn-sm btn-default btn-icon-anim btn-circle" onclick="location.href='<?php echo $this->Url->build('/',true)?>manager/utilisateurs/editmodelsms/<?php echo $enr->id;?>'" ><i class="fa fa-pencil"></i></button>
...
//<script>
    $(document).on('click', ".delete_station", function () {
                    ...
                    swal({   
						...
						$.ajax({
						type: "GET",
						url: "<?php echo $this->Url->build('/',true)?>manager/utilisateurs/deletemodelsms/"+id,
