            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="text-center button-list">
                            ...
                            <button class="btn btn-success mt-5">Modèle Sms Systéme</button>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading icantSelectIt">
                <div class="pull-left">
                        <h6 class="panel-title txt-dark">Modele Sms système</h6>
                </div>
                                ...
                                <tbody>
                                    <?php foreach($modelmessage as $key=>$enr):?>
                                        <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <button class="btn btn-sm btn-default btn-icon-anim btn-circle" onclick="location.href='<?php echo $this->Url->build('/',true)?>manager/utilisateurs/editmodelsmsysteme/<?php echo $enr->id;?>'" ><i class="fa fa-pencil"></i></button>
                                                    </center>
                                                </td>
                                        </tr>
                                    <?php endforeach;?>
