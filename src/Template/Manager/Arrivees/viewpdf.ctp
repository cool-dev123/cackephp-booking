...
<p style="padding:10px"><?php echo $comment?></p>
<br><br>
<?php endif;?>
<p><?php echo $gestionnaire->adresse?>, le <?php echo date("d/m/Y");?></p>
</div>
<div style="width:100%;height:50px;float:left">&nbsp;</div>
<div style="width:100%;float:left">
	<div style="width:70%;float:left">
		Le propriétaire<br/>
		<?php echo $contrat["U"]["prenom"]?> <?php echo $contrat["U"]["nom_famille"]?> "Lu et approuvé"<br/>
		Signature
	</div>
	<div style="width:30%;float:right">
		Le gestionnaire<br/>
		<?php echo $gestionnaire->denominationsociale?> <br/>
		Signature
	</div>
</div>
