...
<table cellpadding="0" cellspacing="0" style="font-family: verdana,arial,sans-serif;font-size:11px;color:#333333 ;border-width: 1px;border-color: #a9c6c9 ;border-collapse: collapse;width: 100%;text-align: center;">
    <thead>
      <tr>
        ...
        background: #0074cc;
        color: white;
        border-color: #0458bf;">Propriétaire</th>
        ...
        background: #0074cc;
        color: white;
        border-color: #0458bf;">Chèque (&euro;)</th>
        <th width="5%" style="border-width: 1px;
        padding: 8px;
        border-style: solid;
        background: #0074cc;
        color: white;
        border-color: #0458bf;">Espèce (&euro;)</th>
        <th width="5%" style="border-width: 1px;
        padding: 8px;
        border-style: solid;
        background: #0074cc;
        color: white;
        border-color: #0458bf;">Carte Bancaire (&euro;)</th>
        <th width="7%" style="border-width: 1px;
        padding: 8px;
        border-style: solid;
        background: #0074cc;
        color: white;
        border-color: #0458bf;">Total Taxe (&euro;)</th>
      </tr>
    </thead>
    <tbody>
      <?php
