            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="text-center button-list">
                            ...
                            <button class="btn btn-success mt-5">Modèle Contrat</button>
                            <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading icantSelectIt">
                <div class="pull-left">
                        <h6 class="panel-title txt-dark">Modele contrat</h6>
                </div>
                    ...
                    <div class="table-wrap">
                        <div>
                            <table id="datable_1" class="table table-hover display  pb-30" >
                                ...
                                <tbody>
                                    <?php foreach($contrats as $key=>$enr):?>
                                        <tr>
                                                <td><?php echo $enr->id?></td>
                                                <td><?php echo $enr->type?></td>
                                                <td>
                                                    <center>
                                                        <button class="btn btn-sm btn-default btn-icon-anim btn-circle" onclick="location.href='<?php echo $this->Url->build('/',true)?>manager/gestionnaires/editmodelcontrat/<?php echo $enr->id;?>'" ><i class="fa fa-pencil"></i></button>
                                                    </center>
                                                </td>
                                        </tr>
                                    <?php endforeach;?>
