                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="col-sm-12 row-eq-height">
                                            <div class="col-sm-3 vcenter align-self-center" style="text-align:center;">
                                                <!--Form-->
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        <button type="button" id="choixsurface" class="btn  btn-orange btn-spec">Affichage par mois</button>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="prixloyer_container">
                                                <button onclick="exportImage('prixloyer_container')" class="btn btn-primary btn-anim pull-right"><i class="fa fa-save"></i><span class="btn-text">Export</span></button>
                                                <br>
                                                <canvas class="resize" id="prixloyer" height="200"></canvas>
                                                <div  id="indexdetail" class="indexdetail">
                            ...
                            <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="pl-0 pr-0 mr-0 ml-0 for_canavas col-lg-10 col-md-9 col-sm-9" id="prixloyersur_container">
                                            ...
                                            <br>
                                            <canvas class="resize" height="250" id="prixloyersur"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
/***** Prix Moyen  *****/
    ...
    var chaine = 'ANNEE : ' + $("#anneechoisie").children(':selected').text() + ' / SURFACE : ' + $("#surfacechoisie").children(':selected').text() + ' / DATE : ' + moment().format('LL');
  ...
  $("#choixsurface").on("click", function (){
    ...
    function choixsurface() {
      ...
      $.ajax({
        ...
        async: false,
        dataType: 'json',
        url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/dataloyerstatischoixsurface/tous/"+annee+"/"+surface,
        success:function(xml){
          ...
          chaine = 'ANNEE : ' + $("#anneechoisie").children(':selected').text() + ' / SURFACE : ' + $("#surfacechoisie").children(':selected').text() + ' / DATE : ' + moment().format('LL');
  ...
  $("#affichagesemaine").on("click", function() {
    ...
    $.ajax({
      ...
      async: false,
      dataType: 'json',
      url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/datasaisonloyerstatis/tous/"+surface,
      ...
      success:function(xml){
        ...
        while (typeof(xml.listeStatSemaineLoyer[an])!="undefined") {
          ...
          colorTabSemaineLoyer.push('#46a3fe');
          dataTabSemaineLoyerTotal.push(xml.listeStatSemaineLoyerTotal[an]);
          colorTabSemaineLoyerTotal.push('#ff530d');
        ...
        chaine = 'SURFACE : ' + $("#surfacechoisie").children(':selected').text() + ' / DATE : ' + moment().format('LL');
