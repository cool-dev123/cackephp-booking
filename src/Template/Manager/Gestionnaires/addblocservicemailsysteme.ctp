    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-wrapper collapse in">
                ...
                <?php
                echo $this->Form->create($blocServiceMail,['url'=>'/manager/gestionnaires/addblocservicemailsysteme','id'=>'frm_periode','class'=> 'form-horizontal']);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-10">
                        ...
                        <textarea class="textarea_editor" name="bloc_services_mail" rows="5" id="bloc_services_mail"></textarea>
                    </div>                    
                </div> 
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-10">
                        <label>Anglais : </label>
                        <textarea class="textarea_editor" name="bloc_services_mail_en" rows="5" id="bloc_services_mail_en"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label mb-10 col-sm-3 col-lg-3 text-left txt-black font-15">Gestionnaires <sup class='text-danger'>*</sup></label>
