...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12">
      <h5 class="txt-dark">Ajouter gestionnaire</h5>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php
            echo $this->Form->create($gestionnaire,['type'=>'file','url'=>'/manager/gestionnaires/add/','id'=>'frm_periode','class'=> 'form-horizontal']);
        ?>
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Rôle : <sup class='text-danger'>*</sup></label>
                    <div class="col-sm-12">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <?php echo $this->Form->select('type',['Personne'=>'Personne','Conciergerie'=>'Conciergerie'],['id'=>'type','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row toHide">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <?php echo $this->Form->select('ville',[],['id'=>'ville','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Villages: <sup class='text-danger'>*</sup></label>
                        <div class="col-sm-12">
                            <?= $this->Form->select('villages[]',$villages,['multiple','id'=>'village','label'=>false,'class'=>'select2 select2-multiple']);  ?>
                            <div id="villages-errors"></div>
                        </div>
                </div>
                <div class="col-sm-6">
                    <?php 
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <?php echo $this->Form->input('denominationsociale',['type'=>'text','id'=>'denominationsociale','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
                <!-- <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <?php //echo $this->Form->input('googlecalendar_id',['type'=>'text','id'=>'googlecalendar_id','label'=>false,'class'=>'form-control', 'required']);  ?>
                    </div>
                </div> -->
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Mot de passe: <sup class='text-danger'>*</sup></label>
                    <div class="col-sm-12">
                        <?php echo $this->Form->input('password',['type'=>'password','id'=>'password','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Saisissez le à nouveau: <sup class='text-danger'>*</sup></label>
                    <div class="col-sm-12">
                        <?php echo $this->Form->input('pass2',['type'=>'password','id'=>'pass2','label'=>false,'class'=>'form-control']);  ?>
                    </div>
                </div>
            </div>
    ...
    var c=false;
        ...
        function(value, element) {
            ...
            $.ajax({
                async : false,
                type: "get",
                url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/checkEmailUnique/null/"+value,
        ...
        function(value, element) {
            ...
            $.ajax({
                async : false,
                type: "get",
                url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/checkLoginUnique/null/"+value,
        ...
        function(value, element) {
            ...
            $.ajax({
                async : false,
                type: "get",
                url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/checkPhoneUnique/null/"+value,
        ...
        function(value, element) {
            ...
            $.ajax({
                async : false,
                type: "get",
                url: "<?php echo $this->Url->build('/',true)?>manager/gestionnaires/checkMobileUnique/null/"+value,
        ...
        errorPlacement: function(error, element) {
            ...
            else if(element.attr("name") == "villages[]")
                $('#villages-errors').append(error)
            else
...
$("#departement").change(function() {  
    ...
    <?php if(!empty($confirm_res)): ?>
        $.toast().reset('all');
                        ...
                        $.toast({
                            heading: 'vous avez bien créé un nouveau gestionnaire',
                            text: '',
