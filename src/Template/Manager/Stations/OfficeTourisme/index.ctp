        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading icantSelectIt">
                <div class="pull-left mt-10">
                        <h6 class="panel-title txt-dark">Offices de tourisme</h6>
                </div>
                <div class="pull-right">
                    <a href="<?php echo $this->Url->build('/',true);?>manager/OfficeTourisme/add/" class="btn btn-primary pull-right">Ajouter Office</a>
                </div>
...
//<script>
    var table;
    $(document).on('click', ".delete_office", function () {
        var id = $(this).attr("data-key");
        swal({
            title: "Suppression d\'un Office",   
            text: "Êtes-vous sûr de vouloir supprimer cet office ?",   
            type: "warning",   
            ...
            $.ajax({
            type: "delete",
            url: "<?php echo $this->Url->build('/',true)?>/manager/OfficeTourisme/delete/"+id,

            success:function(xml){

                $('body').loadingModal('destroy');
                swal("", "Vous venez de supprimer un office", "success");
                table.ajax.reload();
                },
                error: function(){
                    $('body').loadingModal('destroy');
    ...
    $(document).ready(function() {
        ...
        table=$('#datable_1').DataTable({
            ...
            "ajax":{
                "url": "<?= $this->Url->build('/',true)?>manager/OfficeTourisme/alloffices",
            },
