...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12">
      <h5 class="txt-dark">Ajouter Office De Tourisme</h5>
    </div>
</div>
...
<?php if(!empty($confirm_res)): ?>
        ...
        $.toast({
            heading: 'Vous avez crée Un Office',
            text: '',
    ...
    <?php if(!empty($error_res)): ?>
        ...
        $("body").removeAttr('class');
        $.toast({
            heading: "Anomalie au moment de l'enregistrement du Office",
            text: '',
            position: 'bottom-right',
            loaderBg:'#fec107',
            icon: 'error',
