            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="form-wrap col-sm-12 col-xs-12">
                        <?=$this->Form->create($rm,['id'=>'rm','class'=> 'form-horizontal']);?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select multiple name="lieugeos[]" id="lieugeos" class="select2 select2-multiple" required="required">
                                    <?php foreach($lieugeos as $id => $v):?>
                                    <option <?=in_array($id, $RM_lieugeos)?'selected':''?> value="<?=$id?>"><?=$v?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-sm-6 hidden-xs">
                                <div class="panel panel-primary card-view mt-20">
                                    <div class="panel-heading">
                                        <div class="pull-left">
                                            <h6 class="panel-title txt-light">Prix par année</h6>
                                        </div>
                                        ...
                                        <div  class="panel-body row pa-0">
                                            <table class="table table-hover mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Année</th>
                                                        <th>Journée Adulte</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php foreach($prix as $element): ?>
                                                        <tr>
                                                            <td><?=$element->anne?></td>
                                                            <td><?=$element->prixJourne?></td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                </tbody>
                                            </table>
...
<?php if(!empty($confirm_res)): ?>
        ...
        $.toast({
            heading: 'Vous avez modifié une Remonté Mecanique',
            text: '',
