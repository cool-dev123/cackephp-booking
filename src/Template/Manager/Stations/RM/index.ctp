        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading icantSelectIt">
                <div class="pull-left mt-10">
                        <h6 class="panel-title txt-dark">Remontés Mecaniques</h6>
                </div>
                <div class="pull-right">
                    <a href="<?php echo $this->Url->build('/',true);?>manager/Rmecanique/add/" class="btn btn-primary pull-right">Ajouter Une Piste</a>
                </div>
                ...
                <div class="panel-body">
                    <div class="table-wrap">
                        <table id="datable_1" class="table table-hover display  pb-30" >
                            <thead>
                                <tr>
                                    <th>Nom Domaine skiable</th>
                                    <!-- <th>Station</th> -->
                                    <th>Type</th>
                                    <th>km de pistes</th>
                                    <th>pistes</th>
                                    <th>Prix journé <?=date('Y')?></th>
                                    <th>&nbsp;</th>
                                </tr>
                            </thead>
                            <tfoot>
...
//<script>
    var table;
    $(document).on('click', ".delete_rm", function () {
        var id = $(this).attr("data-key");
        swal({
            title: "Suppression d\'une Remonté Mecanique",   
            text: "Êtes-vous sûr de vouloir supprimer cette remonté mecanique ?",   
            type: "warning",   
            ...
            $.ajax({
            type: "delete",
            url: "<?php echo $this->Url->build('/',true)?>/manager/Rmecanique/delete/"+id,

            success:function(xml){

                $('body').loadingModal('destroy');
                swal("", "Vous venez de supprimer une Remonté Mecanique", "success");
                table.ajax.reload();
                },
                error: function(){
                    $('body').loadingModal('destroy');
    ...
    $(document).ready(function() {
        ...
        table=$('#datable_1').DataTable({
            ...
            // ],
            "ajax":{
                "url": "<?= $this->Url->build('/',true)?>manager/Rmecanique/allrm",
            },
