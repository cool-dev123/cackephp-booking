...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12">
      <h5 class="txt-dark">Modifier Domaine</h5>
    </div>
</div>
                ...
                <div class="panel-body">
                    <div class="form-wrap col-sm-12 col-xs-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <?php echo $this->Form->select('massif_id',$massifs,['id'=>'massif_id','label'=>false,'class'=>'form-control']);  ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?= $this->Form->input("descreption",[
                                        'label'=>false,
                                        'templates' => ['inputContainer' => "{{content}}" , 'textarea' => '<textarea class="input text" type="{{type}}" name="{{name}}" {{attrs}} >'.$domaine->descreption.'</textarea >'],
                                        'type'=>'textarea','rows'=>'5',]);
                                ?>
                            </div>
                        </div>
                        <!-- <div class="form-group row">
                            <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Url:</label>
                            <div class="col-sm-6">
...
<?php if(!empty($confirm_res)): ?>
    ...
    <?php if(!empty($error_res)): ?>
        ...
        $("body").removeAttr('class');
        $.toast({
            heading: "Anomalie au moment de la modification du Domaine",
            text: '',
            position: 'bottom-right',
            loaderBg:'#fec107',
            icon: 'error',
