...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12">
      <h5 class="txt-dark">Modifier Partenaire</h5>
    </div>
</div>
                    ...
                    <div class="form-wrap col-sm-12 col-xs-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select multiple name="lieugeo_id[]" id="lieugeo_id" class="select2 select2-multiple" required="required">
                                    <?php foreach($lieugeos as $id => $v):?>
                                    <option <?=in_array($id, $ID_lieugeos)?'selected':''?> value="<?=$id?>"><?=$v?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input id="radioOui" name="aContacter" class="hidden" type="radio" value="OUI" <?=$partenaire->aContacter=='OUI'?'checked':''?>>
                        ...
                        <div class="form-group row">
                            <label class="mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Image (png) : <?php if($partenaire->image == ""){ ?><sup class='text-danger'>*</sup><?php } ?></label>
                            ...
                            <div class="col-sm-6">
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <?php if($partenaire->image != ""){ ?> <input type="hidden"><?php echo $this->Form->file('image',['accept'=>'image/png']); ?><?php } ?>
                                    <?php if($partenaire->image == ""){ ?> <input type="hidden"><?php echo $this->Form->file('image',['accept'=>'image/png', 'required']); ?><?php } ?>
                            ...
                            <div style="text-align: center" class="col-sm-6">
                                ...
                                <img class="zoom" height="100" width="100" src="<?= $this->Url->build('/',true)?>images/partners/<?= $partenaire->image.".png";?>">
                            </div>
                            <?php } ?>
                        </div> 
                        <div class="form-group row">
                          <div class="col-sm-6">
                            ...
                            <input id="radioOuiAff" name="aAfficher" class="hidden" type="radio" value="OUI" <?=($partenaire->aAfficher=='OUI'||$partenaire->aAfficher==null)?'checked':''?>>
                            <input id="radioNonAff" name="aAfficher" class="hidden" type="radio" value="NON" <?=$partenaire->aAfficher=='NON'?'checked':''?>>
                          </div>
                        </div> 
...
$('#Acontacter_switch').bootstrapSwitch('state', <?=$partenaire->aContacter=='OUI'?'true':'false'?>);
...
$('#Aafficher_switch').bootstrapSwitch('state', <?=$partenaire->aAfficher=='OUI'?'true':'false'?>);
$('#Aafficher_switch').on('switchChange.bootstrapSwitch', function (e, state) {
    if(state)
        $('#radioOuiAff').prop("checked", true);
    else
        $('#radioNonAff').prop("checked", true);
});
...
<?php if(!empty($confirm_res)): ?>
    ...
    $.toast({
        heading: 'Vous avez modifié un Partenaire',
        text: '',
