...
<div class="row heading-bg icantSelectIt">
    <div class="col-lg-12">
      <h5 class="txt-dark">Ajouter Massif</h5>
    </div>
</div>
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="form-wrap col-sm-12 col-xs-12">
                        ...
                        <div class="form-group row">
                            <label class="control-label mb-10 mt-10 col-sm-12 text-left font-16 txt-black">Image: <sup class='text-danger'>*</sup></label>
                            ...
                            <div class="col-sm-6">
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <input type="hidden"><?php echo $this->Form->file('image',['accept'=>'image/*', 'required']);?>
...
<?php if(!empty($confirm_res)): ?>
        ...
        $.toast({
            heading: 'Vous avez crée Un Massif',
            text: '',
    ...
    <?php if(!empty($error_res)): ?>
        ...
        $("body").removeAttr('class');
        $.toast({
            heading: "Anomalie au moment de l'enregistrement du Massif",
            text: '',
            position: 'bottom-right',
            loaderBg:'#fec107',
            icon: 'error',
