            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    ...
                    <div class="form-wrap col-sm-12 col-xs-12">
                        <?php
                        echo $this->Form->create(null,['url'=>'/manager/paiements/add','id'=>'frm_periode','class'=> 'form-horizontal form-validate-summernote']);
                        ?>
                        <div class="form-group">
                            <label class="control-label mb-10 col-sm-3 pl-0 text-left font-16 txt-black">Nom : <sup class='text-danger'>*</sup></label>
                            <div class="col-lg-3 col-sm-9">
                                <input class="form-control" name="name" type="text" required="required" data-msg="Veuillez saisir un nom" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-sm-9">
                                <input class="form-control" name="nbr_jour" type="number" required="required" data-msg="Veuillez saisir un nombre" />
                            </div>    
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-sm-9">
                                <input class="form-control" name="taux_commission" type="number" required="required" data-msg="Veuillez saisir un nombre" />
                            </div>    
                        </div>
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-control" name="frais_service" type="number" step="0.01" required="required" data-msg="Veuillez saisir un nombre" />
                                </div> 
                                <div class="col-sm-2 font-20 pt-5 signetype"></div> 
                            </div>                               
                        </div>
...
//<script>
    ...
    <?php if(!empty($confirm_res)): ?>
        $.toast().reset('all');
                        ...
                        $.toast({
                            heading: 'La règle paiement a bien été sauvegardée',
                            text: '',
    ...
    <?php if(!empty($error_res)): ?>
        $.toast().reset('all');
                        $("body").removeAttr('class');
                        $.toast({
                            heading: 'La règle paiement n\'a pas été sauvegardée',
                            text: '',
                            position: 'bottom-right',
                            loaderBg:'#fec107',
                            icon: 'error',
