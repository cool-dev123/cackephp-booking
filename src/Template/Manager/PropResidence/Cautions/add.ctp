            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    ...
                    <div class="form-wrap col-sm-12 col-xs-12">
                        <?php
                        echo $this->Form->create(null,['url'=>'/manager/cautions/add','id'=>'frm_periode','class'=> 'form-horizontal form-validate-summernote']);
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-10">
                                <textarea name="description" class="summernote" required="required" data-msg="Veuillez saisir une description"></textarea>
                                <!-- <textarea style="max-width: 100%" name="description" class="textarea_editor form-control" rows="15"></textarea> -->
                            </div>    
                        </div>
