<div class="row heading-bg icantSelectIt">
    <div class="col-sm-12">
      <h5 class="txt-dark">Modifier un pack</h5>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php
                echo $this->Form->create($pack,['url'=>'/manager/packs/edit/'.$pack->id,'id'=>'frm_periode','class'=> 'form-horizontal']);
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3 col-sm-10">
                        <input name="actif_yn" type="checkbox" <?php if($pack->actif_yn==true) echo 'checked'; ?> class="js-switch js-switch-1"  data-color="#4dad44" data-secondary-color="#eb0000" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-12">
                        <textarea style="max-width: 100%" name="comment" class="textarea_editor form-control" rows="15"><?php echo $pack->comment ?></textarea>
                    </div>    
                </div>
