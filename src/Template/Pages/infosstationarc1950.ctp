  ...
  <div class="row">
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="header_title">
                    <h4 class="gray-fonce">Informations et plans de la station ARC 1950</h4>
    ...
    <div class="row">
       <div class="col-md-12 block">
         <div class="col-md-2">
           <?php echo $this->Html->link($this->Html->image("arc1950-logo.jpg",array("alt"=>"Voir le plan et les informations sur la station des Arcs 1950","title"=>"Renseignement Arc 1950")),"/infos-station-arc-1950.html",array("escape" => false))?>
         </div><!--end col-md-3-->
        <div class="col-md-10 ">
