...
<div id="infos-ville-bourg-saint-maurice">
  ...
  <div class="row">
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="header_title">
                    <h4 class="gray-fonce">Informations et plans de la ville de Bourg Saint Maurice</h4>
    ...
    <div class="row">
       <div class="col-md-12 block">
         <div class="col-md-2">
           <?php echo $this->Html->link($this->Html->image("bourg-saint-maurice-logo.jpg",array("alt"=>"Voir le plan et les informations sur la ville de Bourg St Maurice","title"=>"Renseignements Bourg-Saint-Maurice")),"/infos-ville-bourg-saint-maurice.html",array("escape" => false))?>
