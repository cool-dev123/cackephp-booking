  ...
  <div class="row">
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="header_title">
                    <h4 class="gray-fonce">Informations et plans de la station ARC 2000</h4>
    ...
    <div class="row">
       <div class="col-md-12 block">
         <div class="col-md-2">
           <?php echo $this->Html->link($this->Html->image("arc2000-logo.jpg",array("alt"=>"Voir le plan et les informations sur la station des Arcs 2000","title"=>"Renseignement Arc 2000")),"/infos-station-arc-2000.html",array("escape" => false))?>
         </div><!--end col-md-3-->
        <div class="col-md-10 ">
