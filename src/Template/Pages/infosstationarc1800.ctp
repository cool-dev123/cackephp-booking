  ...
  <div class="row">
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="header_title">
                    <h4 class="gray-fonce">Informations et plans de la station ARC 1800</h4>
    ...
    <div class="row">
       <div class="col-md-12 block">
         <div class="col-md-2">
           <?php echo $this->Html->link($this->Html->image("arc1800-logo.jpg",array("alt"=>"Voir le plan et les informations sur la station des Arcs 1800","title"=>"Renseignement Arc 1800")),"/infos-station-arc-1800.html",array("escape" => false))?>
         </div><!--end col-md-3-->
        <div class="col-md-10 ">
      ...
      <div class="col-md-12 block">
        ...
        <?php echo $this->Html->link($this->Html->image("arc1800_03.png",array("alt"=>"Voir le plan et les informations sur la station des Arcs 1600","title"=>"Renseignement Arc 1600","class"=>"img-arc1600")),"/flash/360-aerien/aerien.html",array("escape" => false,"target"=>"_blank"))?>
        </div><!--end col-md-12-->
      </div><!--end col-md-12-->
