...
{if(f.fbq)return;n=f.fbq=function(){n.callMethod?
	...
	<title>Vacances Les Arcs | Votre séjour ski à la carte sur Alpissime.com</title>
	<meta name="description" content="Réservez vos vacances aux Arcs sur Alpissime | 🏘 Hébergements vérifiés ⛷ Activités en station ⭐️ Services de conciergerie | Paiement en 4x sans frais">
    ...
    <meta property="og:title" content="Vacances Les Arcs | Votre séjour ski à la carte sur Alpissime.com" />
    ...
    <style>
    .header_landing_page {
        background: url(images/LES-ARCS-alpissime-les-arcs-location-entre-particuliers.jpg) no-repeat;
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-3 pb-5 ">
                <h2 class="text-center h1">Locations de vacances aux Arcs</h2>
                <a href="<?php echo $this->Url->build('/', true); ?>annonces/recherche?lieugeo=100" class="float-right font-weight-500 mt-n4 mt-sm-3 mt-md-n4 voir-plus-land"><?= __("Voir plus") ?></a>
            </div>
		</div>
...
<?php 
// Get the JSON
$json = file_get_contents('https://www.alpissime.com/blog/wp-json/wp/v2/posts?categories=739&per_page=3');
...
<section class="bg-light py-5">
    <div class="container">
        <div class="row">
			<div class="col-md-12 text-center">
				<h2 class="h1">A propos des Arcs</h2>                
                <h3 class="font-weight-bold pt-3 h2">Découvrez les stations des Arcs</h3>
                <p class="p-3">
                Située en Savoie au Nord du Parc National de la Vanoise, la station de ski les Arcs bénéficie d’un cadre idéal non loin de Bourg-Saint-Maurice. Elle est composée de plusieurs villages : Arc 1600, Arc 1800, Arc 1950 et Arc 2000. Moderne et avant-gardiste, la station est merveilleusement bien desservie par son fameux funiculaire Arc-en-ciel qui vous amène de Bourg-Saint-Maurice à Arc 1600 en 7 minutes seulement ! Réputée pour ses conditions d’enneigement exceptionnelles, elle vous offre des conditions de glisses favorables toute l’année. Partir aux Arcs c’est aussi profiter d’une station piétonne et sans voiture, avec le Mont-Blanc en toile de fond.
                </p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="font-weight-bold py-3 h2">Les Arcs, l’hiver</h3>
                    <p>Le domaine skiable des Arcs possède les pistes de ski les plus vastes de France, avec un total de 200 km de pistes balisées et desservies par plus de 60 remontées mécaniques. Mieux encore, vous pouvez accéder au domaine du Paradiski, relié avec la Plagne et Peisey-Vallandry, soit 425 km de pistes qui s’offrent à vous par le biais du téléphérique Vanoise express. Une possibilité de varier les plaisirs chaque jour avec quelques 250 pistes réunies sur les deux domaines ! Au pied des Aiguilles Rouge et du Mont Pourri, vous pourrez profiter d’un terrain naturel varié et agréable : traversées, crêtes, vallons, pistes boisées etc ; ou encore perfectionner votre technique dans les nombreuses zones de freestyles, snowparks du domaine ou au sein de son pôle de loisirs “ Mille 8”.</p>
                </div>
                <div class="col-md-6">
                <h3 class="font-weight-bold py-3 h2">Les Arcs l’été</h3>
                    <p>Les Arcs l’été sont aussi dynamiques que l’hiver ! C’est avant tout l’occasion de se défouler avec un large panel de sports accessibles à tous : bike park, descente en rafting, parcours de golfs, Yoga, tir-à-l’arc, mountain kart … ou même de la trottinette sur herbe. Le site est aussi riche en histoire et patrimoine, vous pourrez donc visiter des lieux insolite comme le Fort 2000, aujourd’hui transformé en fromagerie, ou encore visiter les coopératives laitières du coin. Bien évidemment, le lieu fera aussi le bonheur des randonneurs grâce à son cadre préservé et sauvage, dont les spots phares sont les 5 lacs, l'Aiguille Rouge, le Mont Pourri, etc. Enfin, vous pourrez vous détendre au sein des nombreuses structures bien-être des stations des Arcs.</p>
                </div>
            </div>
            </div>
		</div>
