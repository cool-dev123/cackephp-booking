...
<section class="mt-5 mb-4">
    <div class="container">
        <!-- Map -->
        <h2 class="h1 mb-3"><?= __("Locations de vacances à {0} : Résidence {1}", [$residence_info['village']->name, $residence_info->name]); ?></h2>
        <div id="mapdiv" class="col-md-12 maprelative px-0 mt-4 mb-3">
            <div id="map" style="width:100%; height:100%"></div>
        </div>
        <!-- Liste Annonces -->
        <h2 class="text-dark px-2 my-5"><u><a href="<?php echo $this->Url->build('/').$urlLang.$urlvaluemulti['station'];?>/<?php echo $residence_info['village']['lieugeo']->nom_url; ?>" class="text-dark" > <?= $residence_info['village']['lieugeo']->name ?></a></u> > <u><a href="<?php echo $this->Url->build('/',true).$urlLang.$urlvaluemulti['recherche']; ?>?<?php echo $urlvaluemulti['lieugeo']; ?>=<?php echo $residence_info['village']['lieugeo_id']; ?>&village=<?php echo $residence_info['village']['id']; ?>" class="text-dark" > <?= $residence_info['village']->name ?></a></u> > <?= __("Résidence")." ".$residence_info->name ?></h2>
        <div class="col-12">
