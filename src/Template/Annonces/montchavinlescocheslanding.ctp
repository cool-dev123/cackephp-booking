...
{if(f.fbq)return;n=f.fbq=function(){n.callMethod?
	...
	<title>Vacances Montchavin - Les Coches | Séjour ski sur Alpissime.com</title>
	<meta name="description" content="Réservez vos vacances à Montchavin Les Coches sur Alpissime | 🏘 Hébergements vérifiés ⛷ Activités en station ⭐️ Services de conciergerie | Paiement 4x sans frais">
    ...
    <meta property="og:title" content="Vacances Montchavin - Les Coches | Séjour ski sur Alpissime.com" />
    ...
    <style>
    .header_landing_page {
        background: url(images/MONTCHAVIN-LES-COCHES-alpissime-location-entre-particuliers.jpg) no-repeat;
					...
					<div class="rechercheLanding">
						...
						<?php echo $this->Form->create(null,['type'=>'get', 'url' => ['controller' => 'annonces', 'action' => 'recherche'],'id'=>'annonceRechercheForm'])?>
							<div class="form-group">
                                ...
                                <option value="300">Montchavin - Les Coches</option>
                                <option value="19">&nbsp;&nbsp;&nbsp;&nbsp; Montchavin</option>
								<option value="20">&nbsp;&nbsp;&nbsp;&nbsp; Les Coches</option>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-3 pb-5 ">
                <h2 class="text-center h1">Locations de vacances au Montchavin - Les Coches</h2>
                <a href="<?php echo $this->Url->build('/', true); ?>annonces/recherche?lieugeo=300" class="float-right font-weight-500 mt-n4 mt-sm-3 mt-md-n4 voir-plus-land"><?= __("Voir plus") ?></a>
            </div>
		</div>
...
<?php 
// Get the JSON
$json = file_get_contents('https://www.alpissime.com/blog/wp-json/wp/v2/posts?categories=746&per_page=3');
...
<section class="bg-light py-5">
    <div class="container">
        <div class="row">
			<div class="col-md-12 text-center">
				<h2 class="h1">A propos de Montchavin - Les Coches</h2>                
                <!-- <h3 class="font-weight-bold pt-3 h2">Montchavin - Les Coches</h3> -->
                <p class="p-3">
                Située dans la Tarentaise au cœur de la Savoie, Montchavin - Les Coches est une station de ski accueillante qui a su conserver une ambiance authentique. Face au Mont-Blanc vous serez charmé par l'authenticité du vieux village à l'architecture unique (fameux toits de lauzes). La station de Montchavin - Les Coches est également proche des villes de Aime et Bourg-Saint-Maurice et est donc facilement accessible en TGV depuis les grandes villes. Idéale pour la famille, elle est labellisée Famille Plus et offre de nombreuses garderies et ateliers pour enfants.                </p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="font-weight-bold py-3 h2">Montchavin - Les Coches l’hiver</h3>
                    <p>Son domaine skiable est composé des deux principaux centres stations de Montchavin et des Coches, qui sont situés entre 1250 et 1450 m d’altitude pour un total de 225 km de piste que compose le domaine skiable de la Plagne. La station permet aussi d'accéder au fameux téléphérique de Vanoise express accessible depuis le quartier Le Chanton permettant ainsi une liaison facile avec les pistes des Arcs et de Peisey Vallandry. Choisir un séjour au ski à Montchavin - Les Coches , c’est s’offrir un immense terrain de jeu, car les pistes connectées au domaine skiable de la station font partie du second plus grand domaine skiable relié au monde, le domaine Paradiski !</p>
                </div>
                <div class="col-md-6">
                <h3 class="font-weight-bold py-3 h2">Montchavin - Les Coches l’été</h3>
                    <p>Montchavin - Les Coches en été, c’est l’occasion d’admirer la nature et d’en profiter ! Un large choix de sentiers balisés vous y attend : lac du Carroley, lac noir, Mont Pourri, etc. Ainsi q’un large panel d’activités intéressantes  : plus de 70 sports tous niveaux et un choix de loisir à pratiquer seul ou en familles (canoë, VTT, équitation, rafting, escalade, etc)
                    <br>Son complexe aquatique wellness « l’espace Paradisio » permet de se détendre à tous moments de l’année : hammam, sauna, jacuzzi, espace jeux pour enfants, espace soin, spa, massages, etc. Ne manquez pas également les visites locales et insolites comme une découverte des fermes locales où l’on y apprend le savoir faire des paysans de la vallée.</p>
                </div>
            </div>
            </div>
		</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="regular slider">
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner2.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner2.png" type="image/png">
                            <img alt="Partenaire Precision SKI" src="<?php echo $this->Url->build('/',true)?>images/partners/partner2.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner1.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner1.png" type="image/png">
                            <img alt="Partenaire ESF" src="<?php echo $this->Url->build('/',true)?>images/partners/partner1.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner5.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner5.png" type="image/png">
                            <img alt="Partenaire Les ARCS" src="<?php echo $this->Url->build('/',true)?>images/partners/partner5.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner6.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner6.png" type="image/png">
                            <img alt="Partenaire Laradiostation" src="<?php echo $this->Url->build('/',true)?>images/partners/partner6.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner7.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner7.png" type="image/png">
                            <img alt="Partenaire APST" src="<?php echo $this->Url->build('/',true)?>images/partners/partner7.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner8.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner8.png" type="image/png">
                            <img alt="Partenaire Val d'allos" src="<?php echo $this->Url->build('/',true)?>images/partners/partner8.png"/>
                        </picture>
                    </div>
                    <div >
                        <picture>
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner12.webp" type="image/webp">
                            <source srcset="<?php echo $this->Url->build('/',true)?>images/partners/partner12.png" type="image/png">
                            <img alt="Partenaire plagne montchavin" src="<?php echo $this->Url->build('/',true)?>images/partners/partner12.png"/>
                        </picture>
                    </div>
                </div>
            </div>
